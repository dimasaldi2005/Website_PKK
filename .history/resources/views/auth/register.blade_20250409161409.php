...
<body>
    ...
    <script>
        ...
        // Kontrol dropdown desa berdasarkan jenis kantor
        document.getElementById('jenis_kantor').addEventListener('change', function () {
            const jenisKantor = this.value;
            const desaSelect = document.getElementById('desa');

            if (jenisKantor === 'kecamatan') {
        ...
        window.addEventListener('DOMContentLoaded', function () {
            // Inisialisasi jenis kantor
            const jenisKantor = document.getElementById('jenis_kantor').value;
            const desaSelect = document.getElementById('desa');
            ...
            // Inisialisasi kecamatan jika ada nilai
