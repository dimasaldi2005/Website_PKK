...
<head>
  ...
  <title>Laporan Jumlah Kader Pokja 4 (Riwayat)</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Daftar Laporan Jumlah Kader Pokja 4 (Riwayat)</h1>
    </div>
            ...
            <tbody>
              ...
              @forelse ($data2 as $row)
                <tr>
                  ...
                  <td class="text-center">{{ $row->posyandu ?? '0' }}</td>
                  <td class="text-center">{{ $row->gizi ?? '0' }}</td>
                  <td class="text-center">{{ $row->kesling ?? '0' }}</td>
                  ...
                  <td class="text-center">
                    <form action="{{ route('declaporanpokja4.destroy', $row->id_kader_pokja4)}}" method="POST" class="d-inline delete-form">
                      @csrf
                      @method('DELETE')
