...
<head>
  ...
  <title>Laporan Kesehatan (Riwayat)</title>
...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Daftar Laporan Kesehatan (Riwayat)</h1>
    </div>
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">{{ $sehat1->jumlah_posyandu ?? '0' }}</td>
                <td class="text-center">{{ $sehat1->jumlah_posyandu_iterasi ?? '0' }}</td>
                ...
                <td class="text-center" style="white-space: nowrap;">
                  <form action="{{ route('deckesehatan.destroy', $sehat1->id_pokja4_bidang1)}}" method="POST" class="d-inline delete-form">
                    @csrf
                    @method('DELETE')
