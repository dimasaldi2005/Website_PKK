        ...
        <div class="col-md-12 mx-auto mt-2">
          ...
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('pangan.update', $data->id_pokja3_bidang1) }}" method="POST"
                ...
                <div class="form-outline mb-4">
                  ...
                  <div class="form-outline mb-4 mt-3">
                    <label for="id_pokja3_bidang1" class="form-label">ID Laporan Program Pangan</label>
                    <input type="text" name="id_pokja3_bidang1" id="id_pokja3_bidang1" class="form-control" required
                  ...
                  <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="beras" id="beras" class="form-control" required readonly
                      oninvalid="this.setCustomValidity('Harap lengkapi kategori laporan')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul" value="{{ $data->beras }}" />
                  </div>

                  <div class="form-outline mb-4 mt-3">
                    <label for="non_beras" class="form-label">Non Beras</label>
                    <input type="text" name="non_beras" id="non_beras" class="form-control" required readonly
                  ...
                  <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="peternakan" id="peternakan" class="form-control" required readonly
                  ...
                  <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="perikanan" id="perikanan" class="form-control" required readonly
                  ...
                  <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="warung_hidup" id="warung_hidup" class="form-control" required readonly
                  ...
                  <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="lumbung_hidup" id="lumbung_hidup" class="form-control" required readonly
                      oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul"
                  ...
                  <div class="form-outline mb-4 mt-3">
                    ...
                    <input type="text" name="toga" id="toga" class="form-control" required readonly
                      oninvalid="this.setCustomValidity('Harap lengkapi jumlah anggota')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul" value="{{ $data->toga }}" />
                  </div>

                  <div class="form-outline mb-4 mt-3">
                    <label for="tanaman_keras" class="form-label">Tanaman Keras</label>
                    <input type="text" name="tanaman_keras" id="tanaman_keras" class="form-control" required readonly
                      oninvalid="this.setCustomValidity('Harap lengkapi jumlah klp')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul"
