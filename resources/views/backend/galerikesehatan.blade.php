...
<main id="main" class="main">
    <section class="section">
        <h1 class="page-heading">Galeri Kesehatan</h1>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <div style="display: inline-flex; gap: 6px; align-items: center;">
                                    <a href="{{ route('galerikesehatan.edit', $tampil->id) }}" class="btn-act btn-act-edit" title="Review" style="margin-right: 0 !important;">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>

                                    <form action="{{ route('galerikesehatan.destroy', $tampil->id) }}" method="POST" class="delete-form" style="margin: 0; display: inline;">
                                        @csrf
                                        @method('DELETE')
