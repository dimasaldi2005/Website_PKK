...
<head>
    ...
    <title>Laporan Kegiatan Pokja 4 - Prioritas</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Laporan Kegiatan Pokja 4 - Prioritas</h1>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="white-space: nowrap;">
                                    ...
                                    <a href="{{ route('prioritas.pokja4.edit', $item->id_kegiatan_pokja4) }}"
                                    ...
                                    <form action="{{ route('prioritas.pokja4.destroy', $item->id_kegiatan_pokja4)}}"
                                        method="POST"
