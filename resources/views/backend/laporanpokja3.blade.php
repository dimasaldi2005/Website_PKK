              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th class="text-center" scope="col">Tata Laksana Rumah</th>
...
$no = 1;
                  ...
                  @forelse ($data as $got1)
                    ...
                    <td class="text-center">{{ $got1->pangan }}</td>
                    <td class="text-center">{{ $got1->sandang }}</td>
                    <td class="text-center">{{ $got1->tata_laksana_rumah }}</td>
                    <td>{{ $got1->status }}</td>
                    <td>{{ $got1->created_at}}</td>
                    <td>
                       <a href="{{ route('laporanpokja3.edit', $got1->id_kader_pokja3) }}" class="btn btn-sm btn-tambah">Review</a>
          ...
          @empty
                  <div class="alert alert-danger mt-4">
                      Tidak ada data laporan kader pokja 3
                  </div> 
                  @endforelse
