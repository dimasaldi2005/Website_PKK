...
<head>
  ...
  <title>Laporan Kader Pokja 1</title>
            ...
            <tbody>
              ...
              @forelse ($data as $got1)
                <tr>
                  ...
                  <td class="text-center">
                    <a href="{{ route('laporanpokja1.edit', $got1->id_kader_pokja1) }}" class="btn btn-sm btn-info text-white me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Review Data">
                      <i class="bi bi-search"></i>
                    </a>
                    
                    <form action="{{ route('laporanpokja1.destroy', $got1->id_kader_pokja1)}}" method="POST" class="d-inline delete-form">
                      @csrf
                      @method('DELETE')
