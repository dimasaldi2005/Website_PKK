    ...
    <div class="card mt-2">
      <div class="card-body">
        ...
        @elseif (Auth::guard('pengguna')->check())
          <th class="text-center" scope="col">Desa</th>
        @endif
              <th class="text-center" scope="col">PKBN</th>
              <th class="text-center" scope="col">PKDRT</th>
              <th class="text-center" scope="col">Pola Asuh</th>
        ...
        @elseif (Auth::guard('pengguna')->check())
          <td class="text-center">{{ $got1->nama_desa }}</td>
        @endif
            <td class="text-center">{{ $got1->PKBN }}</td>
            <td class="text-center">{{ $got1->PKDRT }}</td>
            <td class="text-center">{{ $got1->pola_asuh }}</td>
            <td>{{ $got1->status }}</td>
            <td>{{ $got1->created_at }}</td>
            <td>
            <a href="{{ route('laporanpokja1.edit', $got1->id_kader_pokja1) }}"
              class="btn btn-sm btn-tambah">Review</a>

            <form action="{{ route('laporanpokja1.destroy', $got1->id_kader_pokja1)}}" method="POST"
