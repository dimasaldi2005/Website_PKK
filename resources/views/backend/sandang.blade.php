...
<head>
  ...
  <title>Laporan Industri Rumah Tangga</title>
...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Daftar Laporan Program Industri Rumah Tangga</h1>
    </div>
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">{{ $sehat1->jasa ?? '0' }}</td>
                ...
                <td class="text-center" style="white-space: nowrap;">
                  <a href="{{ route('sandang.edit', $sehat1->id_pokja3_bidang2) }}" class="btn btn-sm btn-info text-white me-1" data-bs-toggle="tooltip" title="Review Data">
                    <i class="bi bi-search"></i>
                  </a>
                  
                  <form action="{{ route('sandang.destroy', $sehat1->id_pokja3_bidang2)}}" method="POST" class="d-inline delete-form">
                    @csrf
                    @method('DELETE')
              ...
              <tr>
                <td colspan="9" class="text-center py-5">
                  <div class="alert alert-danger mb-0">
                    <i class="bi bi-exclamation-triangle-fill me-2"></i> Tidak ada data laporan program Industri Rumah Tangga.
                  </div>
                </td>
              </tr>
              @endforelse
