      ...
      <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-xxl-4 col-md-6">
            <div class="card info-card sales-card">
              <a href="{{ route('galeripenghayatan.index') }}">
                <div class="card-body">
                  <h5 class="card-title">Penghayatan Dan Pengamalan </br> Pancasila</h5>
          ...
          <div class="col-xxl-4 col-md-6">
            <div class="card info-card sales-card">
              <a href="{{ route('galerigotongroyong.index') }}">
                <div class="card-body">
          ...
          <div class="col-xxl-4 col-md-6">
            <div class="card info-card sales-card">
              <a href="{{ route('galerilaporanpokja1.index') }}">
                <div class="card-body">
