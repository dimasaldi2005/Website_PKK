...
<head>
  ...
  <title>Laporan Pendidikan dan Keterampilan (Riwayat)</title>
...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Daftar Laporan Pendidikan Dan Keterampilan (Riwayat)</h1>
            ...
            <tbody>
              ...
              @forelse ($data2 as $peng1)
                <tr>
                  ...
                  <td class="text-center">
                    <form action="{{ route('decpendidikan.destroy', $peng1->id_pokja2_bidang1)}}" method="POST" class="d-inline delete-form">
                      @csrf
                      @method('DELETE')
