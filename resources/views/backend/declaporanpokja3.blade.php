...
<head>
  ...
  <title>Laporan Kader Pokja 3 (Riwayat)</title>
...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Daftar Laporan Kader Pokja 3 (Riwayat)</h1>
    </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center" style="white-space: nowrap;">
                  <form action="{{ route('declaporanpokja3.destroy', $sehat1->id_kader_pokja3)}}" method="POST" class="d-inline delete-form">
                    @csrf
                    @method('DELETE')
