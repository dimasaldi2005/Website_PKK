...
<head>
  ...
  <title>Laporan Gotong Royong</title>
...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Daftar Laporan Gotong Royong</h1>
          ...
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <th class="text-center align-middle" scope="col">Jimpitan</th>
                <th class="text-center align-middle" scope="col">Arisan</th>
            ...
            <tbody>
              ...
              @forelse ($data as $got1)
                <tr>
                  ...
                  <td class="text-center">
                    <a href="{{ route('gotongroyong.edit', $got1->id_pokja1_bidang2) }}" class="btn btn-sm btn-info text-white me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Review Data">
