...
<head>
  ...
  <title>Laporan Perumahan & Tata Laksana RT</title>
...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Daftar Laporan Perumahan & Tata Laksana Rumah Tangga</h1>
    </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center" style="white-space: nowrap;">
                  <a href="{{ route('perumahan.edit', $sehat1->id_pokja3_bidang3) }}" class="btn btn-sm btn-info text-white me-1" data-bs-toggle="tooltip" title="Review Data">
                    <i class="bi bi-search"></i>
                  </a>
                  <form action="{{ route('perumahan.destroy', $sehat1->id_pokja3_bidang3)}}" method="POST" class="d-inline delete-form">
                    @csrf
                    @method('DELETE')
