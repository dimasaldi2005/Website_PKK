...
<main id="main" class="main">
    ...
    <section class="section">
        ...
        <div class="form-card">
            <form action="{{ route('galeripengembangan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="text-end">
                    @if (strtolower($data->status) == 'upload')
                        <a href="{{ route('galeripengembangan.index') }}" class="btn-kirim" style="background-color: #6c757d !important; text-decoration: none; display: inline-block;">
                            Kembali
                        </a>
                    @else
