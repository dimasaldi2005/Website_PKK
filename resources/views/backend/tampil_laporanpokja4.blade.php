    ...
    <section class="section">
      <div class="row">
        <div class="col-md-12 mx-auto mt-2">
          <div class="pagetitle">
            <h1>Review Laporan Kader Pokja 4</h1>
          </div><!-- End Page Title -->
          <div class="card">
            <div class="card-body mt-4">
              <form action="{{ route('laporanpokja4.update', $data->id_kader_pokja4) }}" method="POST"
                ...
                <div class="form-outline mb-4">
                  ...
                  <div class="form-outline mb-4 mt-3">
                    <label for="id_kader_pokja4" class="form-label">ID Laporan Kader Pokja 4</label>
                    <input type="text" name="id_kader_pokja4" id="id_kader_pokja4" class="form-control" required
                      ...
                      value="{{ $data->id_kader_pokja4 }}" />
                  </div>

                  <div class="form-outline mb-4 mt-3">
                    <label for="posyandu" class="form-label">Posyandu</label>
                    <input type="text" name="posyandu" id="posyandu" class="form-control" required readonly
                      oninvalid="this.setCustomValidity('Harap lengkapi kategori laporan')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul" value="{{ $data->posyandu }}" />
                  </div>

                  <div class="form-outline mb-4 mt-3">
                    <label for="gizi" class="form-label">Gizi</label>
                    <input type="text" name="gizi" id="gizi" class="form-control" required readonly
                      oninvalid="this.setCustomValidity('Harap lengkapi jumlah posyandu')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul" value="{{ $data->gizi }}" />
                  </div>

                  <div class="form-outline mb-4 mt-3">
                    <label for="kesling" class="form-label">Kesling</label>
                    <input type="text" name="kesling" id="kesling" class="form-control" required readonly
                      oninvalid="this.setCustomValidity('Harap lengkapi jumlah tata laksana rumah')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul" value="{{ $data->kesling }}" />
                  </div>

                  <div class="form-outline mb-4 mt-3">
                    <label for="penyuluhan_narkoba" class="form-label">Penyuluhan Narkoba</label>
                    <input type="text" name="penyuluhan_narkoba" id="penyuluhan_narkoba" class="form-control" required
                      readonly oninvalid="this.setCustomValidity('Harap lengkapi jumlah tata laksana rumah')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul"
                      value="{{ $data->penyuluhan_narkoba }}" />
                  </div>

                  <div class="form-outline mb-4 mt-3">
                    <label for="PHBS" class="form-label">PHBS</label>
                    <input type="text" name="PHBS" id="PHBS" class="form-control" required readonly
                      oninvalid="this.setCustomValidity('Harap lengkapi jumlah tata laksana rumah')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul" value="{{ $data->PHBS }}" />
                  </div>

                  <div class="form-outline mb-4 mt-3">
                    <label for="KB" class="form-label">KB</label>
                    <input type="text" name="KB" id="KB" class="form-control" required readonly
                      oninvalid="this.setCustomValidity('Harap lengkapi jumlah tata laksana rumah')"
                      oninput="this.setCustomValidity('')" placeholder="Masukkan Judul" value="{{ $data->KB }}" />
                  </div>
