    ...
    <div class="card mt-2">
      ...
      @endphp
        ...
        <tr>
          ...
          <td>{{ $tampil->status }}</td>
          <td>
          <a href="{{ route('galerilaporanpokja1.edit', $tampil->id)}}" class="btn btn-sm btn-tambah">Review</a>
          <form action="{{ route('galerilaporanpokja1.destroy', $tampil->id)}}" method="POST"
