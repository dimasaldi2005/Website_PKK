...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Daftar Laporan Kader Pokja 4</h1>
    </div><!-- End Page Title -->
    ...
    <div class="card mt-2">
      <div class="card-body">
        ...
        @endif
              ...
              <th class="text-center" scope="col">Penyuluhan Narkoba</th>
      ...
      @endphp
        ...
        @elseif (Auth::guard('pengguna')->check())
          <td class="text-center">{{ $sehat1->nama_desa }}</td>
        @endif
            <td class="text-center">{{ $sehat1->posyandu }}</td>
            <td class="text-center">{{ $sehat1->gizi }}</td>
            <td class="text-center">{{ $sehat1->kesling }}</td>
            <td class="text-center">{{ $sehat1->penyuluhan_narkoba }}</td>
            <td class="text-center">{{ $sehat1->PHBS }}</td>
            <td class="text-center">{{ $sehat1->KB }}</td>
            <td>{{ $sehat1->status }}</td>
            <td>{{ $sehat1->created_at }}</td>
            <td>
            <a href="{{ route('laporanpokja4.edit', $sehat1->id_kader_pokja4) }}"
              class="btn btn-sm btn-tambah">Review</a>

            <form action="{{ route('laporanpokja4.destroy', $sehat1->id_kader_pokja4)}}" method="POST"
