    ...
    <div class="card mt-2">
      ...
      @endphp
        ...
        @endif
            ...
            <td>
            <form action="{{ route('decsandang.destroy', $sehat1->id_pokja3_bidang2) }}" method="POST"
      ...
      @empty
        <div class="alert alert-danger mt-4">Tidak ada data laporan sandang</div>
      @endforelse
          </tbody>
        </table>
