...
class DecLaporanPokja4Controller extends Controller
{
    public function index()
    {
        ...
        if (Auth::guard('web')->check()) {
            ...
            $data2 = DB::table('laporan_kader_pokja4')
                ...
                ->orderBy('id_kader_pokja4', 'desc')->get();
            ...
            if ($user->id_role == 2) { // KECAMATAN: Lihat yang sudah mereka ACC
                ...
                $data2 = DB::table('laporan_kader_pokja4')
                    ...
                    ->whereIn('laporan_kader_pokja4.status', ['Disetujui1', 'Disetujui2'])
                    ->orderBy('id_kader_pokja4', 'desc')->get();
            }
        }
    ...
    {
        LaporanPokja4::where('id_kader_pokja4', $id)->delete();
        return redirect()->route('declaporanpokja4.index')->with('success', 'Riwayat Berhasil Dihapus');
    }
}